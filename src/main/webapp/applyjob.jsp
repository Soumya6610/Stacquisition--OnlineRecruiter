...
<title>Stacquisition - Apply Job</title>
<meta name="keywords"
						...
						<table>
							<center>
								<s:form action="applyjob111">
									<s:select label="Select Job Post" name="j_id"
										list="mapForSelect1" headerKey="-1"
										headerValue="--Please Select--" />
									<tr>
										<td colspan="2" align="right"><s:submit value="Apply" /></td>
									</tr>
