...
<title>Stacquisition - Select Question</title>
<meta name="keywords"
		...
		<div id="templatemo_content">
			...
			<div id="column_w530">
				...
				<center>
					...
					<s:form action="selectjobid">
						<s:select label="Select JobID" name="  id" list="mapForSelect"
							headerKey="-1" headerValue="----Select----"></s:select>
						<s:submit value="Show"></s:submit>
					</s:form>
					<s:form action="selectexamid">
						<s:select label="Select ExamID" name="loginid" list="mapForSelect"
							headerKey="-1" headerValue="----Select----"></s:select>
						<s:submit value="Show"></s:submit>
					</s:form>
