...
<title>Stacquisition - Question</title>
<meta name="keywords"
				...
				<center>
					...
					<s:form action="question">
						<table>
							...
							<tbody>
								<tr valign="top">
									<td><s:textfield name="slno" label="Serial No."></s:textfield></td>
								</tr>

								<tbody>
									<tr valign="top">
										<td><s:textarea name="question" label="Question"></s:textarea></td>
									</tr>
									<tbody>
										<tr valign="top">
											<td><s:textfield name="option1" label="Option_1"></s:textfield></td>
										</tr>

										<tbody>
											<tr valign="top">
												<td><s:textfield name="option2" label="Option_2"></s:textfield></td>
											</tr>
											<tbody>
												<tr valign="top">
													<td><s:textfield name="option3" label="Option_3"></s:textfield></td>
												</tr>
												<tbody>
													<tr valign="top">
														<td><s:textfield name="option4" label="Option_4"></s:textfield></td>
													</tr>
													<tbody>
														<tr valign="top">
