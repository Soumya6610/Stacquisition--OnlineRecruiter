...
<title>Stacquisition - Exam Creation</title>
<meta name="keywords"
				...
				<center>
					<s:form action="registerexam">
						<table>
							...
							<tr>
								<td><s:textfield name="examname" label="Exam Name"></s:textfield></td>
							</tr>
							<tr>
								<td><s:textfield name="c_post" label="Post"></s:textfield></td>
							</tr>
							<tr>
								<td><s:textfield name="c_cuttoff" label="Cutoff"></s:textfield></td>
							</tr>
