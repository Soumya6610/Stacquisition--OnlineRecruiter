...
<title>Stacquisition - Campus Schedule</title>
<meta name="keywords"
		...
		<div id="templatemo_content">
			...
			<div id="column_w530">
				...
				<center>
					...
					<br />
					<table border="1">
						<s:form action="showschedule">
							<table>
								<s:select label="Select Company" name="c_id" list="mapForSelect"
									headerKey="-1" headerValue="----Select----"></s:select>

								<!-- <tr><td><s:textfield name="c_name" label="company name"></s:textfield></td></tr> -->
								<tr>
									<td><sx:datetimepicker name="date11" label="Date"
