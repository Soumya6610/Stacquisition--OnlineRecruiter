...
<body>
	<div id="templatemo_header_wrapper">
		...
		<div id="templatemo_header">
			<strong><br /> <br /></strong>
			<div>
				<font size="6" color="red"><strong>Stacquisition -
						Set Your Future Job & Face Here</strong> System</font>
			</div>
					...
					<tr>
						<s:form action="updatejob">
							<td id="tds" align="left"><input id="tds" type="text"
								value="<%=rs.getString(2)%>" name="post"
								style="border: 0px; size: 10px"></input></td>
							<td id="tds" align="left"><input id="tds" type="text"
								value="<%=rs.getString(3)%>" name="criteria" style="border: 0px" /></td>
							<td id="tds"><input id="tds" type="text"
								value="<%=rs.getLong(4)%>" name="vacancies" style="border: 0px" /></td>
							<td id="tds"><input id="tds" type="text"
								value="<%=rs.getLong(5)%>" name="salary" style="border: 0px" /></td>
							<td id="tds"><input id="tds" type="text"
								value="<%=rs.getString(6)%>" name="lastdate" style="border: 0px" /></td>
