...
<title>Stacquisition - View Syllabus</title>
<meta name="keywords"
					...
					<s:form>
						...
						<table border="1">
							...
							try {
								...
								String sql = "select c.C_NAME, cs.* from COMPANYDETAILS c,CAMPUSSYLLABUS cs where c.c_id=cs.c_id";
							...
							<tr>
								...
								<td><input type="hidden" value="<%=c_id%>" name="c_id" /></td>
							</tr>
