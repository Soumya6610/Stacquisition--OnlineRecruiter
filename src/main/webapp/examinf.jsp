...
<title>Stacquisition - Exam Info</title>
<meta name="keywords"
		...
		<div id="templatemo_header">
			...
			<div id="templatemo_menu">
				...
				<ul>
					...
					<li><a href="viewcampusschedule.jsp">Check Exam Schedule<br /></a></li>
					<li><a href="viewsyllabus.jsp">Check Exam Syllabus<br /></a></li>
					<li><a href="viewhalltickt12">Check Hallticket<br /></a></li>
				</ul>
			</div>
			<!-- end of menu -->
