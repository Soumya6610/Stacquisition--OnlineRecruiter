...
<title>Stacquisition - Change Password</title>
<meta name="keywords"
	...
	<div id="templatemo_content_wrapper">
		<div id="templatemo_content">
			...
			<div id="column_w530">
				...
				<center>
					<table border="1">
						<s:form action="change_password" name="p" onsubmit="return fun()">
							<table>
								<tr>
									<td><s:hidden name="password"></s:hidden></td>
								</tr>
								<tr>
									<td><s:password name="p1" label="Enter New Password"></s:password></td>
								</tr>
								<tr>
									<td><s:password name="p2" label="Confirm Password"></s:password></td>
								</tr>
								<tr>
									<td></td>
								</tr>
								<tr>
									<td align="right"><s:submit value="Change"></s:submit></td>
								</tr>
								</center>
