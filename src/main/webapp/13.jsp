...
<body>
    ...
    Long cid = (Long)request.getAttribute("cid");
   	ResultSet rs =DbConnect.getStatement().executeQuery("select * from QUESTION where SLNO=2 and c_id="+cid+""); 
     if(rs.next()){
   ...
   } else
   {
    ...
    rs =DbConnect.getStatement().executeQuery("select * from QUESTION where SLNO=3 and c_id="+cid+""); 
