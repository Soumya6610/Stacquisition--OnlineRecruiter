...
<title>Stacquisition - Closing of Job</title>
<meta name="keywords"
		...
		<div id="templatemo_content">
			...
			<div id="column_w530">
				...
				<center>
					...
					<s:form action="closejob1">

						<s:textfield name="js_id"></s:textfield>
						<tr>
						...
						<tr>
							<td><s:textfield name="vacancies" label="No. of Vacancies"></s:textfield></td>
						</tr>
						<tr>
							<td><s:textfield name="salary" label="Salary"></s:textfield></td>
						</tr>
						<tr>
							<td><sx:datetimepicker name="lastDate" label="Closing Date"
									displayFormat="dd-MMM-yyyy" value="todayDate" /></td>
						</tr>
						<tr>
							<td colspan="2" align="right"><s:submit value="CLOSE" /></td>
						</tr>
