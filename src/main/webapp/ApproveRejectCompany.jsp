...
<title>Stacquisition - Approve/Reject Company</title>
<meta name="keywords"
					...
					<s:form>
						...
						<table border="1">
							...
							try {
								...
								String sql = "select c.* from LOGIN l,companydetails c where l.LOGIN_ID=c.LOGIN_ID and l.USERSTATUS='notapproved'";
							...
							<tr>
								...
								<td><s:form action="aaa">
										<input type="hidden" value="<%=c_id%>" name="c_id" />
										<s:submit value="Reject" action="RejectCompany"></s:submit>
									</s:form></td>
								<td><s:form action="aaa">
										<input type="hidden" value="<%=c_id%>" name="c_id" />
										<s:submit value="Approve" action="approveCompany"></s:submit>
									</s:form></td>
							</tr>
