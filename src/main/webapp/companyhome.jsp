...
<title>Stacquisition - Home | Company</title>
<meta name="keywords"
		...
		<div id="templatemo_header">
			...
			<div id="templatemo_menu">
				...
				<ul>
					...
					<li><a href="updatecompany">Edit Profile<br /></a></li>
					...
					<li><a href="Question.jsp">Create Question<br /></a></li>
					<li><a href="viewresult.jsp">result view<br /></a></li>
					<li><a href="Exam Details.jsp">Exam Details<br /></a></li>
					<li><a href="changepassword1.jsp">Change Password<br /></a></li>
			...
			<div id="templatemo_banner_image">
				<div id="templatemo_banner_image_wrapper">
					&nbsp; <img src="images/6.jpg" alt="image 2"
						style="top: 2px; left: 60px; height: 450px; width: 690px;" />
				</div>
			</div>
