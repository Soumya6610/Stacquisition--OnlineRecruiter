...
<title>Stacquisition - Add/Delete Jobseeker</title>
<meta name="keywords"
...
<body>
	<div id="templatemo_header_wrapper">
		...
		<div id="templatemo_header">
			...
			<br />
			<div>
				<font size="6" color="red">Stacquisition - Set Your Future Job & Face Here</font>
			</div>
	...
	<div id="templatemo_content_wrapper">
					...
					<s:form action="add">
						<table border="1" width="327" height="30">
							<table>
								...
								<tr>
									<td><s:textfield name="fathers_name" label="Fathers Name"></s:textfield></td>
								</tr>
								<tr>
								...
								<tr>
									<td><s:textfield name="mothers_name" label="Mothers Name"></s:textfield></td>
								</tr>
								<tr>
		...
		for(int i=0;i<al.size();i++){
		  %>
						...
						<center>
							<s:url id="approvedURL" action="add">
								<s:param name="id" value="%{loginid}"></s:param>
							</s:url>
							<s:a href="%{approvedURL}">Approve</s:a>
							<s:url id="rejectURL" action="delete">
								<s:param name="id" value="%{loginid}"></s:param>
							</s:url>
							<s:a href="%{rejectURL}">Reject</s:a>
						</center>
					</s:form>
